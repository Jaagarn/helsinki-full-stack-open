...
describe("favorite blog", () => {
  test("of empty list is object with null values", () => {
  ...
  test("when list has only one blog is object with those values", () => {
  ...
  test("the blog with most likes in a list get returned", () => {
...
describe("author with most blog", () => {
  ...
  test("the author with most blogs in a list get returned", () => {
...
describe("author with most total likes", () => {
  ...
  test("the author with most likes in a list get returned", () => {
